...
return [
    ...
    'filename' => '/var/www/sotabrasil.com.br/user/pages/01.home/activators/item.md',
    'modified' => 1648484332,
    'data' => [
        'header' => [
            'title' => 'Ativadores',
            ...
            'header_image_alt_text' => 'Ativadores',
            'hide_page_title' => false,
            'show_sidebar' => true,
            'continue_link' => true,
            'icon' => 'photo',
            'media_order' => 'activators.jpg',
            'header_image_creditlink' => 'https://www.flickr.com/photos/193115238@N08/51192702152/in/album-72157719244599607/',
            'date' => '21-05-2021 12:50'
        ],
        'frontmatter' => 'title: Ativadores
published: true
hide_from_post_list: false
hide_git_sync_repo_link: true
header_image_credit: \'Douglas, PY1II, Flickr.com\'
...
header_image_creditlink: \'https://www.flickr.com/photos/193115238@N08/51192702152/in/album-72157719244599607/\'
date: \'21-05-2021 12:50\'',
        'markdown' => '<!-- ![AdSense](https://via.placeholder.com/728x90.png)  -->
## Hora de subir a montanha!  
**Ativadores** são todos aqueles radioamadores que sobem as montanhas para operar suas estações portáteis lá de cima.  

Eles se preparam fisicamente, planejam as melhores estratégias, aguardam as melhores oportunidades, preparam os equipamentos mais eficientes e utilizam-se das melhores práticas para fazer os mais incríveis contatos via rádio nas diversas bandas de frequência e nos mais variados modos de operação disponíveis.  
...
O sucesso da ativação também está intrinsecamente relacionado a uma boa divulgação. Portanto, depois de escolher a data e o período de tempo em que será feita a ativação (início e fim da operação de rádio no alto do morro), você deve divulgar tais dados no [SOTAwatch3](https://sotawatch.sota.org.uk/en/). Nesse site, você estará divulgando sua ativação para radioamadores do mundo inteiro! Já para uma divulgação mais local, além do SOTAwatch3 pode-se pensar em alertas nos grupos de radioamadorismo no Whatsapp, por exemplo. O SOTA Brasil, aliás, possui um grupo de Whatsapp bem movimentado. Se você deseja fazer parte de nosso grupo, entre em contato conosco.  

Para inserir um alerta no SOTAwatch3 você deve primeiramente se cadastrar no site. Após o cadastro você poderá fazer seu primeiro login e, finalmente, inserir o seu alerta. Clique [aqui](https://www.youtube.com/watch?v=gWzYT7SwDwQ) para ver como fazer o seu cadastro nos sites essenciais do SOTA.  
<br>

#### 3. A Operação no alto da Montanha
Em breve disponibilizaremos muito mais informações sobre a operação no alto da montanha propriamente dito. Enquanto isso assista em nossa [TV SOTA Brasil](http://tv.sotabrasil.com.br/) a algumas ativações já realizadas.  
<br>

#### 4. Enviar o Log
Após momentos inesquecíveis no topo da montanha em contato com a natureza e inúmeros contatos via rádio você não pode esquecer de enviar o seu log para o [SOTA Data](https://www.sotadata.org.uk/pt/), o banco de dados mundial dos QSOs efetuados por todos os participantes do programa. Ao inserir o seu log no sistema você passará a participar automaticamente do Ranking de Ativadores e poderá adquirir diversos diplomas e troféus na medida em que for acumulando pontos a cada ativação.

Clique [aqui](https://www.youtube.com/watch?v=vBdH0n-bvHM&t) para ver um vídeo sobre como enviar o seu log de ativação para o SOTA Data.'
    ]
];
